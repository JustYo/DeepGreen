...
expt_name = "Sys0-Paper-Experiment"
data_file_prefix = 'data/S0-Oscillator'

# Set size of latent space, and retrieve the 'full' size of the data
units_latent = 20
units_full = get1Ddatasize(data_file_prefix)[
    -1
]  # the last dimension is the 'length' of the data, for 1D data
